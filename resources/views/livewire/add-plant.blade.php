...
<div>
    <form wire:submit.prevent="savePlant">
        @if (!empty($errors))
        @if (count($errors) > 0)
    ...
    @endif
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <input type="text" wire:model="family" id="family" class="form-control" placeholder="Family" name="family">
    ...
    <div class="row">
        <div class="col-lg-6">
            <label for="selectedDiseases">Diseases</label>
        ...
        <hr>
        <input type="submit" wire:click="savePlant" value="{{ isset($plant) ? 'Edit Plant' : 'Create Plant' }}" class="btn btn-{{ isset($plant) ? 'warning' : 'primary' }}">
    </form>
</div>
