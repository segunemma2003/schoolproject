...
<head>
  ...
  <body>
    ...
    <form method="get">
    <input type="text" name="searchTerm" placeholder="Search for diseases..." class="form-control">
            ...
            <tbody>
                ...
                @foreach ($diseases as $disease)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('disease-search-details', ['id' => $disease->id]) }}" class="btn btn-success">View Details</a>
                        </td>
                    </tr>
                @endforeach
